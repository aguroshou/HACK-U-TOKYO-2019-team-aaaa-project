...
public class MoveAnemone : MonoBehaviour
{
    ...
    public ShotAnemone ShotAnemoneScript;
    ...
    void Start()
    {
        ...
        ShotAnemoneScript = MainCamera.GetComponent<ShotAnemone>();
        AirtapCountPast = ShotAnemoneScript.AirtapCount;
    }
    ...
    void Update()
    {
        ...
        if (ShotAnemoneScript.AirtapCount - AirtapCountPast >= 20)
        {
